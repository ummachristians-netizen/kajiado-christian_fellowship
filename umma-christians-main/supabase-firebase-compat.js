    ...
    switch (table) {
        ...
        case "site_config":
            return {
                ...
                theme_day: normalizeText(payload.themeDay ?? payload.themeSemester ?? existing.theme_day),
                theme_semester: normalizeText(payload.themeSemester ?? payload.themeDay ?? existing.theme_semester),
